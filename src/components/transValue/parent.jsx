...
class Parent extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        ...
        >
          {this.state.child2parent}
        </div>
        <div
          ref={this.divRef}
          className={this.state.child2parent ? "content" : "nocontent"}
        >
          {this.state.child12parent}
        </div>
        {
          <button
            id="button"
            ...
            onClick={this.parent2child.bind(
              this,
              "parent父组件向child1子组件传值"
            )}
          >
            parent父组件向child1子组件传值
          </button>
  ...
  componentDidMount() {
    ...
    this.divRef.current.style.color = "green";
